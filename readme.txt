...
To build and run:
	0. Environment
		0.0 Make sure that Apache Maven is installed in your environment (https://maven.apache.org/download.cgi).
		0.1. Make sure JDK 1.8 is insatlled in your environment (https://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html)
